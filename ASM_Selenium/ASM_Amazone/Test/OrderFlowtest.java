...
import AutomationTest.CyberSoft.Selenium.ASM_Amazone.Locator.Locator_CMS;
...
//        ac.keyDown(Keys.CONTROL).sendKeys(Keys.HOME).perform();
    ...
    public void HomePage(){
        driver.findElement(By.xpath(Locator_CMS.ip_searching)).sendKeys("adidas");
        driver.findElement(By.xpath(Locator_CMS.ic_search)).click();
        this.testScrollPage();
    }
